...
def mkUclidVars(varnames: list, typ, porttype):
    return [
        UclidContext.curr_module.mkVar(varname, typ, porttype) for varname in varnames
    ]
...
def mkUclidIntVars(varnames: list, porttype=PortType.var):
    return [
        UclidContext.curr_module.mkIntegerVar(varname, porttype) for varname in varnames
    ]
...
def mkUclidBoolVars(varnames: list, porttype=PortType.var):
    return [
        UclidContext.curr_module.mkBooleanVar(varname, porttype) for varname in varnames
    ]
